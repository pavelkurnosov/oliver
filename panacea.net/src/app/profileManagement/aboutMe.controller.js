...
(function(){
    ...
    angular.module('profileManagement')
        .controller('aboutMeController', patientAccountRegistrationController);

    function patientAccountRegistrationController($scope, $routeParams, userService, registrationService, yearGenerator){
        // var vm = this;
